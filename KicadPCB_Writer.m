...
fprintf(FID, '    (trace_width 0) \n');
fprintf(FID, '    (via_dia 0.6) \n');
...
fprintf(FID,'(kicad_pcb (version 4) (host pcbnew 4.0.7) \n');
fprintf(FID,'  (general \n');
fprintf(FID,'    (links 0) \n');
fprintf(FID,'    (no_connects 0) \n');
fprintf(FID,'    (area 125.6 37.9082 128.700001 40.7442) \n');
fprintf(FID,'    (thickness 0) \n');
fprintf(FID,'    (drawings 0) \n');
fprintf(FID,'    (tracks 0) \n');
fprintf(FID,'    (zones 0) \n');
fprintf(FID,'    (modules 2) \n');
fprintf(FID,'    (nets 1) \n');
fprintf(FID,'  ) \n');
fprintf(FID,'   \n');
fprintf(FID,'   \n');
...
fprintf(FID,'  (setup \n');
fprintf(FID,'    (last_trace_width 0) \n');
...
fprintf(FID,'    (edge_width 0.15) \n');
fprintf(FID,'    (via_size 0.6) \n');
fprintf(FID,'    (via_drill 0.4) \n');
...
fprintf(FID,'      (hpglpendiameter 15) \n');
